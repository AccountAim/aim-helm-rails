module AimHelmRails
  ...
  # identity derives from the class path — Subagents::Researcher is the agent named
  # "subagents/researcher" — so the file is its single source. agent assembles the AimHelm agent.
  class Helmsman
